...
import com.example.smartwatch.databinding.ActivityDesplayBinding
import com.google.firebase.database.DatabaseReference
import com.google.firebase.database.FirebaseDatabase

class DesplayActivity : AppCompatActivity() {
    private lateinit var binding: ActivityDesplayBinding
    private lateinit var databaseReference: DatabaseReference

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDesplayBinding.inflate(layoutInflater)
